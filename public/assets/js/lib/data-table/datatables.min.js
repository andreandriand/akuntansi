  ...
  var S = function (g) {
    ...
    function na(a, b, c, d) {
      var e = [],
        ...
        jb = function (a) {
          if (c === k || c === j)
            (i = l[j]), (n = g.trim(a.innerHTML)), i && i._bAttrSrc ? (Q(i.mData._)(d, n), q(i.mData.sort, a), q(i.mData.type, a), q(i.mData.filter, a)) : r ? (i._setter || (i._setter = Q(i.mData)), i._setter(d, n)) : (d[j] = n);
          j++;
        };
      if (f)
        for (; f; ) {
    ...
    function Va(a, b, c, d) {
      ...
      c && a.oFeatures.bSortMulti
        ? ((c = g.inArray(b, D(e, "0"))), -1 !== c ? ((b = h(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = f[b]), (e[c]._idx = b))) : (e.push([b, f[0], 0]), (e[e.length - 1]._idx = 0)))
        : e.length && e[0][0] == b
